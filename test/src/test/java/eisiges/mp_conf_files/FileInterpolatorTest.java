...
public class FileInterpolatorTest {
	...
	public void setProperties() throws IOException {
		System.setProperty("conf_files.test.var", "ice cream");
		System.setProperty("conf_files.test.var2", "chocolate");
	}
	...
	public void createTestFile() throws IOException {
		...
		try (BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(testFile))) {
			...
			bufferedWriter.write("I want some vanilla ${conf_files.test.var} with ${conf_files.test.var2} chips\n");
		}
	}
	...
	@After
	public void cleanup() {
		System.clearProperty("conf_files.test.var");
		System.clearProperty("conf_files.test.var2");
